...
Use the least-squares slope to find $\hat\beta$ and $\hat\alpha$:
...
Use equation 9.14b to estimate the variance (I don't know how to create an upside down hat symbol..):
